...
[![My Skills](https://skillicons.dev/icons?i=ts,js,python,html,react,neovim,aws,railway,rust,discord,mysql,mongodb,bun,cloudflare,discord,docker,express,figma,gcp,kubernetes,md,mongodb,postgres,raspberrypi,svelte,vscode)](https://skillicons.dev)
