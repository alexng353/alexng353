...
[![My Skills](https://skillicons.dev/icons?i=ts,js,python,html,react,neovim,aws,planetscale,rust,discord,mysql,mongodb,cloudflare,discord,docker,express,figma,gcp,kubernetes,md,mongodb,postgres,raspberrypi,svelte,vscode,vercel,tailscale)](https://skillicons.dev)
